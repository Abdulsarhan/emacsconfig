...
with the only major differences being is that it uses nerd-icons instead of all-the-icons. I did this so that I could use the symbols included with nerd fonts with my emacs config. It also has avy-go-to char and evil-mc for added productivity benefits. 
