;;; abdulmacs-theme.el --- Theme

;; Copyright (C) 2023 , Abdulrahman Sarhan

;; Author: Abdulrahman Sarhan
;; Version: 0.1
...
;;; Commentary:
;;; abdulmacs theme created by Abdulrahman Sarhan in 2023
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-buffer-id ((,class (:bold t :foreground ,fg4 :background ,unspec))))
...
(provide-theme 'abdulmacs)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; abdulmacs-theme.el ends here
